		...
		<div class="registration">
			<h2>Registration Form</h2>				
					<form:form name="form" action="registrationPost.htm" commandName="user" method="post">
						<div class="form-info">
						<form:input path="fullname" id="fullname" name="fullname" class="text" placeholder="Enter Your Name"/><font color="red"><form:errors path="fullname"/></font>
					...
					<li><a href="loginGet.htm">LOGIN</a></li>
					</ul>
							<div class="clear"> </div>
		</div>
		<script>
